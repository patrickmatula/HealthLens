const PATHS = {
  ...
  shoe: 'M3 17.5c0-1.15.75-2.16 1.85-2.5l3.6-1.1 3.5-2.8c.9-.72 2.05-1.02 3.18-.83l4.2.72A3 3 0 0122 14.15V16h.5a1.5 1.5 0 011.5 1.5V18a1 1 0 01-1 1H4a1 1 0 01-1-1v-.5z',
  body: 'M12 2a2.5 2.5 0 110 5 2.5 2.5 0 010-5zM7.5 9a1.5 1.5 0 011.5-1.5h6A1.5 1.5 0 0116.5 9v5a1.5 1.5 0 01-1.2 1.47L15.5 21h-2l-.3-5h-2.4l-.3 5h-2l-.2-5.53A1.5 1.5 0 017.5 14V9z',
  sync: 'M17.65 6.35A7.95 7.95 0 0012 4a8 8 0 00-7.75 6h2.08A6 6 0 0112 6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35zM4 13v7l2.35-2.35A7.95 7.95 0 0012 20a8 8 0 007.75-6h-2.08A6 6 0 0112 18c-1.66 0-3.14-.69-4.22-1.78L11 13H4z',
} as const
